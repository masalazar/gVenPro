...
/**
 * Created by MarceloUsuario on 12-23-2017.
 */

public class bdStoPro {
    public long Agregar(String IdStock, String IdProveedor, String CantidadFisica,String ValorCompra, String Subido, Context context){
        ...
        Cursor c = Buscar(context,"0","0","0","0",IdStock);
    ...
    public String obtIdStock(Context context,String IdProducto, String IdSucursal,String Valor){
        bdBase usdbh =
                new bdBase(context, "gComida", null, Funciones.gVersionBD);
        ...
        if (c.moveToFirst()) {
            IdStock = c.getString(c.getColumnIndex("IdStock"));
        }else {
            IdStock = String.valueOf(oStock.Agregar(IdSucursal,IdProducto,"0","0","1","N",Valor,context));
        }

        return IdStock;
    }
    public void ModificarCantidad(String IdProveedor,String IdProducto, String IdSucursal,String Cantidad, Context context){
        String IdStock = obtIdStock(context,IdProducto,IdSucursal,"0");
    ...
    public Cursor Buscar(Context context, String IdStoPro,String IdProveedor, String IdProducto,String IdSucursal,String IdStock){
        bdBase usdbh =
                new bdBase(context, "gComida", null, Funciones.gVersionBD);
        ...
        if (!IdStock.equals("0")){
            varSQL = varSQL + " AND STO.IdStock = " + IdStock;
        }
